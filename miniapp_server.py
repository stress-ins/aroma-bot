...
from miniapp.api.routers import carousel, create, drafts, keywords, misc, plans, publish, references, reels
...
for _router in (drafts.router, carousel.router, reels.router, plans.router, references.router, create.router, keywords.router, misc.router, publish.router):
