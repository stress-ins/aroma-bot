...
def _setup_mounts_and_routers():
    ...
    from miniapp.api.routers import (
        admin, analytics, archive, blend_constructor, carousel, create, drafts, hashtags,
        inbox, keywords, mentions, misc, plans, publish, rag, recommendations, references,
        reels, repurpose, schedule, series, social, social_trends, stock_photos,
        teams, thread_monitor, threads_series, tokens, tone, trend_cards, trends,
        user, webhooks,
    )
    ...
    for _router in (
        admin.router, analytics.router, archive.router, blend_constructor.router, drafts.router, carousel.router, inbox.router, reels.router,
