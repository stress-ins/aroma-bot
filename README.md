...
| `/content` | Агентный флоу: цель → формат → тема → готовый контент-пакет |
...
3. Claude в роли набора агентов предлагает темы на основе актуальных трендов
4. Вы выбираете тему
5. Бот возвращает готовый контент-пакет:
   - angle
   - hook
