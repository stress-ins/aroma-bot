...
- Мясной совет, быстрый туториал или наблюдение из практики.
- НЕ используй формат "Первый. Второй. Третий." — это звучит как робот. Пиши как рассказ или перечисляй через абзацы без нумерации.
- Каждый пункт должен быть конкретным и понятным без контекста. Плохо: "Записать одно, что сработало в теле за 24 часа". Хорошо: "Вечером вспомни, от чего телу стало легче за день."
