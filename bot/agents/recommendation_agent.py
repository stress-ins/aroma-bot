...
_SYSTEM_PROMPT = "Ты — эксперт по ароматерапии. На основе предпочтений пользователя подбери 3 эфирных масла из предоставленного справочника. Для каждого масла укажи: slug (из справочника), причину выбора (2-3 предложения) и практику применения на день."
_USER_PROMPT = "Настроение: {mood}\nЦель: {goal}\nСимптомы: {symptoms}\nПредпочтения по аромату: {aroma_preferences}\nПротивопоказания: {contraindications}\n\nСправочник масел:\n{reference_context}\n\nВерни строго JSON:\n{{\n  \"recommendations\": [\n    {{\"slug\": \"lavender\", \"name_ru\": \"Лаванда\", \"reason\": \"...\", \"daily_practice\": \"...\"}},\n    ...\n  ],\n  \"general_advice\": \"...\"\n}}"
