...
НЕ использовать: капли масла в миску/чашу с водой (эфирное масло в воде не растворяется).
НЕ использовать: дымящийся ладан, бахур, горящие ароматические смолы — у автора нет этого оборудования.
Эфирное масло применяется так: каплю на ладонь → растереть ладони → вдыхать с ладоней. Или — диффузор. Именно так и снимать.
...
Хорошо: "помогает расслабить плечи и перестать контролировать каждый вдох".
...
- НЕ использовать: капли масла в воду или в миску с водой
- НЕ использовать: дымящийся ладан, горящие смолы
- Эфирное масло: нанести каплю на ладонь → растереть → вдыхать с ладоней. Именно так снимать.
