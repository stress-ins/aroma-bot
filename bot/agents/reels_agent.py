...
Если тема связана с ароматерапией или эфирными маслами:
...
Для остальных тем — показывай то, что органично для темы, без привязки к ароматам.
...
- Для остальных тем: снимай то, что органично для темы.
