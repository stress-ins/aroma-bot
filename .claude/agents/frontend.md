...
2. Реализуешь UI-часть в соответствующих JS/CSS/шаблонах
3. Проверяешь работу во всех 6 темах
4. Убеждаешься что нет inline-обработчиков, хардкодных цветов, Lucide
5. Передаёшь @qa для тестирования
