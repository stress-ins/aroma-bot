...
PROMPT = (
    "Сократи описание эфирного масла до 1-2 коротких предложений на русском языке. "
    "Если оригинал на английском — переведи на русский. "
    "Сохрани все ключевые факты и эмоциональный тон. "
    "Не добавляй информацию, которой нет в оригинале. "
    "Не начинай с названия масла. Ответь только текстом саммари на русском."
)
